...
gs_dyn_array(card_data_t) card_database;

static void card_database_add(card_data_t card) {
...
void card_database_init() {
    ...
    card_database_add(card_create("Red 2/3", 2, 3, true, false, false, COMMON, 1, (card_abilities_t){0}));
    card_database_add(card_create("Red 3/2", 3, 2, true, false, false, COMMON, 1, (card_abilities_t){0}));
    card_database_add(card_create("Red 2/2 Sharpen 2", 2, 2, true, false, false, COMMON, 1, (card_abilities_t){.sharpen=2}));
    card_database_add(card_create("Red 2/2 Strike 2", 2, 2, true, false, false, COMMON, 1, (card_abilities_t){.strike=2}));
    card_database_add(card_create("Red 3/1 Haste", 3, 1, true, false, false, COMMON, 1, (card_abilities_t){.haste=true}));
    card_database_add(card_create("Red 1/2 Mass Sharp 1", 1, 2, true, false, false, COMMON, 1, (card_abilities_t){.mass_sharpen=1}));
    ...
    card_database_add(card_create("Green 3/2", 3, 2, false, true, false, COMMON, 1, (card_abilities_t){0}));
    card_database_add(card_create("Green 2/3", 2, 3, false, true, false, COMMON, 1, (card_abilities_t){0}));
    card_database_add(card_create("Green 2/1 Heal 3", 2, 1, false, true, false, COMMON, 1, (card_abilities_t){.heal=3}));
    card_database_add(card_create("Green 2/2 Shield", 2, 2, false, true, false, COMMON, 1, (card_abilities_t){.shield=true}));
    card_database_add(card_create("Green 3/1 Regenerate", 3, 1, false, true, false, COMMON, 1, (card_abilities_t){.regenerate=true}));
    card_database_add(card_create("Green 1/2 Mass heal 1", 1, 2, false, true, false, COMMON, 1, (card_abilities_t){.mass_heal=1}));
    ...
    card_database_add(card_create("Blue 1/4", 1, 4, false, false, true, COMMON, 1, (card_abilities_t){0}));
    card_database_add(card_create("Blue 2/3", 2, 3, false, false, true, COMMON, 1, (card_abilities_t){0}));
    card_database_add(card_create("Blue 1/3 Dull 2", 1, 3, false, false, true, COMMON, 1, (card_abilities_t){.dull=2}));
    card_database_add(card_create("Blue 3/5 Frozen", 3, 5, false, false, true, COMMON, 1, (card_abilities_t){.frozen=true}));
    card_database_add(card_create("Blue 2/2 Evade", 2, 2, false, false, true, COMMON, 1, (card_abilities_t){.evade=true}));
    card_database_add(card_create("Blue 1/2 Mass Dull 1", 1, 2, false, false, true, COMMON, 1, (card_abilities_t){.mass_dull=1}));
...
card_data_t card_get_random(bool red, bool green, bool blue) {
    ...
    card_data_t card = filtered_cards[random_index];
    gs_dyn_array_free(filtered_cards);
    return card;
}

bool hand_contains_card(gs_dyn_array(card_data_t) hand, card_data_t card) {
...
gs_dyn_array(card_data_t) hand_get_random(bool red, bool green, bool blue) {
    gs_dyn_array(card_data_t) hand = NULL;
    for (int i = 0; i < 6; i++) {
        card_data_t card = card_get_random(red, green, blue);
...
gs_dyn_array(card_data_t) hand_get_random_color() {
    int color = rand() % 3;
    bool red = color == 0;
    bool green = color == 1;
    bool blue = color == 2;
